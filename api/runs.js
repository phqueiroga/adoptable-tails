...
export default { async fetch(request) {
  ...
  const run={id:randomUUID(),status:"queued",created_at:new Date().toISOString(),updated_at:new Date().toISOString(),briefing:normaliseBriefing(payload.briefing),prompt_version:"attractions-v3-places",outputs:{},tool_calls:[],handoffs:[],validations:{},usage:{calls:0,input_tokens:0,output_tokens:0,estimated_cost_usd:0,agents:{}}};
