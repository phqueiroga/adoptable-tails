...
export async function callStructured(agent, input, tracker) {
  const isMaker=agent.name==="Maker",isDesigner=agent.name==="Designer",isResearcher=agent.name==="Researcher",isCommunicator=agent.name==="Communicator",isManager=agent.name==="Manager",max_tokens=isMaker?9500:isDesigner?2600:isResearcher?3200:isCommunicator?2000:isManager?1700:1200;
